...
zypper refresh
zypper -n install brasero rhythmbox smplayer libreoffice hashdeep gparted qbittorrent gcc  \
                  cmake calibre krita gimp trojan R-base libxml2-devel libcurl-devel fontconfig-devel
