...
zypper refresh
zypper -n install brasero rhythmbox smplayer libreoffice hashdeep gparted qbittorrent  \
                  cmake calibre krita gimp trojan R-base libxml2-devel libcurl-devel fontconfig-devel gcc gcc-c++ make gcc-fortran
zypper -n update
