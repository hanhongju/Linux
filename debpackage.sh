...
apt    -y   install              ./v2rayN-linux-64.deb   ./WeChatLinux_x86_64.deb   ./balena-etcher_1.19.25_amd64.deb   ./rstudio-2024.12.1-563-amd64.deb      ./finalshell_linux_x64.deb   ./code_1.97.2-1739406807_amd64.deb
